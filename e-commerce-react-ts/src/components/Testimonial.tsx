...
import image from '../../src/assets/image/testimonial1.png';

const Testimonial: React.FC = () => {
  return (
    <>
      <h2 className="text-center font-bold text-2xl m-8">Testimonial</h2>
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap -m-4">
            <div className="lg:w-1/3 sm:w-1/2 w-full mb-6 p-4">
              <div className="h-full text-center">
                <img
                  alt="testimonial"
                  className="w-20 h-20 mb-8 object-cover object-center rounded-full inline-block border-2 border-gray-200 justify-center"
                  src={image}
                />
